...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter a Prux address or contact"))
        ...
        self.setWindowTitle("Electrum-PRUX")
    ...
    def the_website(self):
        webbrowser.open("http://electrum-prux.org")
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        label = QLabel(_("Copied your Prux address to the clipboard!"))
        ...
        self.setWindowTitle("Electrum - " + _("Receive Prux payment"))
...
class MiniActuator:
    ...
    def waiting_dialog(self, f):
        ...
        w = QDialog()
        w.resize(200, 70)
        w.setWindowTitle('Electrum-PRUX')
